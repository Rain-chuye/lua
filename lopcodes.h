...
#define GETARG_B_I(i)	getarg(i, POS_B, SIZE_B)
#define SETARG_B_I(i,v)	setarg(i, v, POS_B, SIZE_B)

#define GETARG_C_I(i)	getarg(i, POS_C, SIZE_C)
#define SETARG_C_I(i,v)	setarg(i, v, POS_C, SIZE_C)

#define GETARG_Bx_I(i)	getarg(i, POS_Bx, SIZE_Bx)
#define SETARG_Bx_I(i,v)	setarg(i, v, POS_Bx, SIZE_Bx)

#define GETARG_Ax_I(i)	getarg(i, POS_Ax, SIZE_Ax)
#define SETARG_Ax_I(i,v)	setarg(i, v, POS_Ax, SIZE_Ax)
